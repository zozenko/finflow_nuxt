...
<template>
  <div class="flex flex-col items-center mt-4 gap-4">
    ...
    <div class="grid w-full grid-cols-1 md:grid-cols-2 gap-8 mt-4">
      <StatisticProgressBarList
        :title="t(`statistics.progress.${selectedType}_groups`)"
        :stats="groupStats"
        type="group"
      />
      <StatisticProgressBarList
        :title="t(`statistics.progress.${selectedType}_categories`)"
        :stats="categoryStats"
        type="category"
      />
    </div>
